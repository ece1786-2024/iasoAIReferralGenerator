...
4. With regards to the 'other' field for the reason of referral section: if the reasons already specified do not cover an integral point from the patient-doctor conversations or the clinical notes, insert the additional information into the 'other' field. This field is not required to be filled but could be used for any additional patient notes.
